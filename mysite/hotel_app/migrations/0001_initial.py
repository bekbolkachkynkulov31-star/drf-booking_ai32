    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('Одноместный', 'Одноместный'), ('Двухместный', 'Двухместный'), ('Семейный', 'Семейный'), ('Люкс', 'Люкс')], max_length=15)),
                ('room_status', models.CharField(choices=[('Свободень', 'Свободень'), ('Забронировать', 'Забронировать')], default='Свободень', max_length=15)),
